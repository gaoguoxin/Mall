...
<div class="blank"></div>
 <div id="ur_here">
当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=67">酱油</a> <code>&gt;</code> 老才臣 
</div>
</div>
<div class="blank"></div>
...
<div class="box">
 <div class="box_1">
  ...
  <a href="category.php?category=67&display=grid&brand=15&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list"><img src="themes/ecmoban_benlai/images/goods_id_default.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=67&display=grid&brand=15&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/ecmoban_benlai/images/shop_price_DESC.gif" alt="按价格排序"></a>
  <a href="category.php?category=67&display=grid&brand=15&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/ecmoban_benlai/images/last_update_default.gif" alt="按更新时间排序"></a>
