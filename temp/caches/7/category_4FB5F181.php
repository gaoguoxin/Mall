...
<div class="blank"></div>
 <div id="ur_here">
当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=67">酱油</a> <code>&gt;</code> 海天 
</div>
</div>
<div class="blank"></div>
  ...
  <div class="AreaR">
		 ...
		 <div class="box_1">
			<h3><span>商品筛选</span></h3>
						<div class="screeBox">
			  <strong>品牌：</strong>
														<a href="category.php?id=67&amp;price_min=0&amp;price_max=0">全部</a>&nbsp;
																			<span>海天</span>
...
<div class="box">
 <div class="box_1">
  ...
  <a href="category.php?category=67&display=grid&brand=14&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list"><img src="themes/ecmoban_benlai/images/goods_id_default.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=67&display=grid&brand=14&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/ecmoban_benlai/images/shop_price_default.gif" alt="按价格排序"></a>
  <a href="category.php?category=67&display=grid&brand=14&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/ecmoban_benlai/images/last_update_ASC.gif" alt="按更新时间排序"></a>
