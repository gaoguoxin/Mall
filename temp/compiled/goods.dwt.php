...
?>
          <li><?php echo $this->_var['property']['value']; ?>：<?php echo $this->_var['property']['value']; ?></li>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?> 
...
?>
    ...
    <div id="ranklist" class="m m2">
      ...
      <div class="mc">
        ...
        <ul class="tabcon">
          <?php $_from = $this->_var['top10_price']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_37951300_1408520398');$this->_foreach['top10_price'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['top10_price']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_37951300_1408520398']):
...
?>
          <li class="fore<?php echo $this->_foreach['top10_price']['iteration']; ?>"><span><?php echo $this->_foreach['top10_price']['iteration']; ?></span>
            <div class="p-img"><a href="<?php echo $this->_var['goods_0_37951300_1408520398']['url']; ?>"><img height="50" width="50" src="<?php echo $this->_var['goods_0_37951300_1408520398']['thumb']; ?>"></a></div>
            <div class="p-name"><a href="<?php echo $this->_var['goods_0_37951300_1408520398']['url']; ?>" title="<?php echo $this->_var['goods_0_37951300_1408520398']['short_name']; ?>"><?php echo $this->_var['goods_0_37951300_1408520398']['short_name']; ?></a></div>
            <div class="p-price"><strong class="J-p-942510"><?php echo $this->_var['goods_0_37951300_1408520398']['price']; ?></strong></div>
          </li>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </ul>
        <ul class="tabcon hide">
          <?php $_from = $this->_var['top10_brand']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_38006000_1408520398');$this->_foreach['top10_brand'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['top10_brand']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_38006000_1408520398']):
...
?>
          <li class="fore<?php echo $this->_foreach['top10_brand']['iteration']; ?>"><span><?php echo $this->_foreach['top10_brand']['iteration']; ?></span>
            <div class="p-img"><a href="<?php echo $this->_var['goods_0_38006000_1408520398']['url']; ?>"><img data-img="1" height="50" width="50" src="<?php echo $this->_var['goods_0_38006000_1408520398']['thumb']; ?>" class="err-product"></a></div>
            <div class="p-name"><a href="<?php echo $this->_var['goods_0_38006000_1408520398']['url']; ?>" title="<?php echo $this->_var['goods_0_38006000_1408520398']['short_name']; ?>"><?php echo $this->_var['goods_0_38006000_1408520398']['short_name']; ?></a></div>
            <div class="p-price"><strong class="J-p-1029670"><?php echo $this->_var['goods_0_38006000_1408520398']['price']; ?></strong></div>
          </li>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </ul>
        <ul class="tabcon hide">
          <?php $_from = $this->_var['top10_category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_38044600_1408520398');$this->_foreach['top10_category'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['top10_category']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_38044600_1408520398']):
...
?>
          <li class="fore<?php echo $this->_foreach['top10_category']['iteration']; ?>"><span><?php echo $this->_foreach['top10_category']['iteration']; ?></span>
            <div class="p-img"><a href="<?php echo $this->_var['goods_0_38044600_1408520398']['url']; ?>"><img height="50" width="50" src="<?php echo $this->_var['goods_0_38044600_1408520398']['thumb']; ?>" class="err-product"></a></div>
            <div class="p-name"><a href="<?php echo $this->_var['goods_0_38044600_1408520398']['url']; ?>" title="<?php echo $this->_var['goods_0_38044600_1408520398']['short_name']; ?>"><?php echo $this->_var['goods_0_38044600_1408520398']['short_name']; ?></a></div>
            <div class="p-price"><strong class="J-p-1094930"><?php echo $this->_var['goods_0_38044600_1408520398']['price']; ?></strong></div>
          </li>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </ul>
      </div>
