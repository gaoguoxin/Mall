...
?> 
          ...
          <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_93442400_1409735039');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_93442400_1409735039']):
?>
          <div class="prop-attrs">
            <div class="attr">
              <div class="a-key"><?php echo htmlspecialchars($this->_var['filter_attr_0_93442400_1409735039']['filter_attr_name']); ?>：</div>
              <div class="a-values">
                <div class="v-fold">
                  <ul class="f-list">
                    <?php $_from = $this->_var['filter_attr_0_93442400_1409735039']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
