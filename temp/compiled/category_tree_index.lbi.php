...
?>
          <div  class="dt" <?php if (count ( $this->_var['cat']['cat_id'] ) > 0): ?> onMouseOver="sw_nav2(<?php echo $this->_foreach['no']['iteration']; ?>,1);" onMouseOut="sw_nav2(<?php echo $this->_foreach['no']['iteration']; ?>,0);" <?php endif; ?>>
            <div id="HandleLI2_<?php echo $this->_foreach['no']['iteration']; ?>">
              <a class="a <?php if (($this->_foreach['no']['iteration'] - 1) % 2 == 0): ?><?php else: ?>t<?php endif; ?>" href="<?php echo $this->_var['cat']['url']; ?>">
                ...
                <?php if (count ( $this->_var['cat']['cat_id'] ) > 0): ?>
                  <img src="themes/ecmoban_benlai/images/biao8.gif">
                <?php endif; ?>
              </a>
            </div>
            <?php if (count ( $this->_var['cat']['cat_id'] ) > 0): ?>
...
?>
                  <?php if (count ( $this->_var['child']['cat_id'] ) > 0): ?>
