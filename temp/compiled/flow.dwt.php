...
?>
              ...
              <td align="center" bgcolor="#ffffff">
                ...
                <a href="javascript:collect(<?php echo $this->_var['goods']['goods_id']; ?>) " class="f6"><?php echo $this->_var['lang']['drop_to_collect']; ?></a>
                <?php endif; ?>            </td>
            </tr>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          </table>
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
          <tr>
            <td bgcolor="#ffffff"><a href="./"><img src="themes/ecmoban_benlai/images/nstep1_btn1.gif" alt="continue" /></a></td>
            <td bgcolor="#ffffff" align="right"><a href="flow.php?step=checkout"><img src="themes/ecmoban_benlai/images/nstep1_btn2.gif" alt="checkout" /></a></td>
          </tr>
        </table>
...
?>
        ...
        <?php echo $this->smarty_insert_scripts(array('files'=>'utils.js,user.js,transport.js')); ?>
        <script type="text/javascript">
