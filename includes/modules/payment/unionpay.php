...
if (isset($set_modules) && $set_modules == TRUE) {
    ...
    $modules[$i]['config'] = array(
        array(
            'name' => 'mer_id',
            'type' => 'text',
            'value' => '821620159994001'
        ),
    );
    // 签名证书密码
    return;
}
defined('SDK_SIGN_CERT_PATH') or define('SDK_SIGN_CERT_PATH', realpath(dirname(__FILE__)) . '/cer/' . 'newzs.pfx');
defined('SDK_SIGN_CERT_PWD') or define('SDK_SIGN_CERT_PWD', '123');
defined('SDK_VERIFY_CERT_DIR') or define('SDK_VERIFY_CERT_DIR', realpath(dirname(__FILE__)) . '/cer/');
defined('SDK_FRONT_TRANS_URL') or define('SDK_FRONT_TRANS_URL', 'https://gateway.95516.com/gateway/api/frontTransReq.do');
defined('SDK_BACK_TRANS_URL') or define('SDK_BACK_TRANS_URL', 'https://gateway.95516.com/gateway/api/backTransReq.do');
defined('SDK_SINGLE_QUERY_URL') or define('SDK_SINGLE_QUERY_URL', 'https://gateway.95516.com/gateway/api/queryTrans.do');
